...
5. Perskaitykite funkcijos aprašymą: `?facet_wrap`.
    a. Kokią funkciją atlieka `nrow`? nusako eiluciu sk
    b. Kokią funkciją atlieka `ncol`? nusako stulpeliu sk
    c. Kurios kitos funkcijos kontroliuoja facečių išdėstymą? 
    d. Kodėl funkcija `facet_grid()` neturi parametrų `nrow` ir `ncol`? nes isdestoma gaal tai kiek reik6mi7
